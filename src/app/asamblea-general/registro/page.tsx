...
export default function AsambleaRegistroPage() {
  return (
    <>
      <div className="pt-16 bg-[#050B16] relative overflow-hidden border-b border-[#C9A227]/40">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(201,162,39,0.12),transparent_60%)]" />
      ...
      <section className="py-10 sm:py-20 bg-[#050B16] relative overflow-hidden">
