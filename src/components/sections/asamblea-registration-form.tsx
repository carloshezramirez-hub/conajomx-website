  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-[#DCE8F2] shadow-[0_8px_32px_rgba(10,45,82,0.08)] p-6 sm:p-8">
      <div className="grid sm:grid-cols-2 gap-5">
        ...
        <div>
          <Label className="text-[#526173] text-sm mb-1.5 block">
            Cargo <span className="text-[#A51C30]">*</span>
          </Label>
          <select
            value={data.cargo}
            onChange={(e) => update("cargo", e.target.value)}
            className="flex h-9 w-full rounded-md border border-[#DCE8F2] bg-white px-3 py-1 text-sm text-[#071D3A] shadow-xs outline-none focus:border-[#A51C30]/60 focus-visible:ring-2 focus-visible:ring-[#A51C30]/20"
          >
