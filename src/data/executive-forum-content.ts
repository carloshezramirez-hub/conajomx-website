    ...
    es: {
      ...
      speakers: [
        ...
        },
        {
          ...
          initials: "RTG",
          image: "/assets/conajomx/people/raul-torres-guerrero.webp",
        ...
        },
        {
          ...
          initials: "ESA",
          image: "/assets/conajomx/people/eugenio-silva-alvarez.webp",
...
const ui = {
  es: {
    ...
    sedeEyebrow: "Sede",
    sedeTitle: "Eliot Lyman Room · Longfellow Hall",
    sedeSubtitle: "Harvard Graduate School of Education",
...
const registro = {
  es: {
    ...
    description:
      "¿Eres estudiante y te interesa participar en el Executive Forum? Cambridge & Boston Leadership Experience, en el Eliot Lyman Room, Longfellow Hall, Harvard Graduate School of Education, el 4 de septiembre de 2026. Déjanos tus datos y te contactaremos con los siguientes pasos.",
    venueBadge: "Eliot Lyman Room, Longfellow Hall — HGSE",
  ...
  en: {
    ...
    description:
      "Are you a student interested in taking part in the Executive Forum? Cambridge & Boston Leadership Experience, at the Eliot Lyman Room, Longfellow Hall, Harvard Graduate School of Education, on September 4, 2026. Leave us your details and we'll reach out with next steps.",
    venueBadge: "Eliot Lyman Room, Longfellow Hall — HGSE",
