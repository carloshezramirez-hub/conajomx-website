...
const panels: LocalizedPanel[] = [
  {
    ...
    en: {
      ...
      speakers: [
        ...
        {
          name: "Mateo Rull Garza",
          company: "Office of Congresswoman Ayanna Pressley",
          initials: "MRG",
          image: "/assets/conajomx/people/mateo-rull-garza.webp",
          bio: "Advisor & Constituent Advocacy Manager, working on immigration, food access, urban agriculture, education, and climate justice for Massachusetts' 7th congressional district.",
        },
      ],
    },
  },
